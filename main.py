...
from src.api import user_api , categorie_api , product_api , mouvement_api
...
app.include_router(mouvement_api.mouvement_router , tags = ["Product mouvement (Input and Outpout)"])